...
/**
 * View model for {@link JavaStatic}.
 *
 * @author Mike Virata-Stone
 */
public class JavaStaticView extends ViewModel {
    private final JavaStatic javaStatic;

    public JavaStaticView(QueryHandler handler, JavaStatic javaStatic) {
        super(handler);
